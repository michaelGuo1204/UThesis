...
\centering
\subfigure[阈值0.315]{
\includegraphics[width=6cm]{figures/Chapter4/VEM/Explain/0.315.png}
}
\subfigure[阈值0.32]{
\includegraphics[width=6cm]{figures/Chapter4/VEM/Explain/0.32.png}
}
\subfigure[阈值0.325]{
\includegraphics[width=6cm]{figures/Chapter4/VEM/Explain/0.325.png}
}
\subfigure[阈值0.33]{
\includegraphics[width=6cm]{figures/Chapter4/VEM/Explain/0.33.png}
}
\caption{子图阈值化结果}
